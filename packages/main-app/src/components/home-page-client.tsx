...
const features = [
  {
    title: "Verified Professionals & Employers",
    description:
      "Connect with vetted professionals and legitimate employers in the luxury private service industry.",
  ...
  },
  {
    ...
    description:
      "Our smart system connects the right professionals with the right opportunities for both sides.",
    icon: ({ className }: { className?: string }) => (
      <svg
        className={className}
        fill="none"
  ...
  },
  {
    ...
    description:
      "Personalized support to help professionals advance their careers and employers find exceptional talent.",
    icon: ({ className }: { className?: string }) => (
      <svg
        className={className}
        fill="none"
          ...
          <section className="pt-32 pb-20 px-4">
            <div className="container mx-auto text-center">
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                Where Top Estate Service
                <br />
                <span className="text-blue-600">Professionals & Employers Connect</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                The premier platform connecting exceptional estate service professionals 
                with discerning employers in the luxury private service industry.
              </p>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-400">
                  Connecting top estate service professionals with discerning employers in the luxury private service industry.
                </p>
              </div>
              <div>
